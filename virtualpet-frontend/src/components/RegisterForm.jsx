    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        ...
        <input
          ...
          className="w-full px-3 py-2 bg-gray-800 border-2 border-cyan-400 text-yellow-300 focus:outline-none focus:border-magenta-500 font-pixel"
      ...
      <button
        ...
        disabled={isSubmitting}
      >
        {isSubmitting ? 'CREANT...' : 'CREATE ACCOUNT'}
      </button>
    </form>
  );
};
